...
import static net.worldseed.util.math.CoordConversion.globalToBlock;
import static net.worldseed.util.math.CoordConversion.globalToChunk;

/**
 * Represents a 3D point.
 *
 * Copied from Minestom's Point class.
 */
